<?php
class add_st_slideshow {

	var $pluginname = 'st_slideshow';
	var $path = '';
	var $internalVersion = 100;

	function add_st_slideshow()  {

		// Set path to editor_plugin.js
		$this->path = get_template_directory_uri() . '/lib/editor/tinymceSlideshow/';
	...
	function add_tinymce_langs_path($plugin_array) {
		...
		$plugin_array[$this->pluginname] = '/tinymce/langs.php';
		return $plugin_array;
	}
...
$tinymce_button = new add_st_slideshow ();
