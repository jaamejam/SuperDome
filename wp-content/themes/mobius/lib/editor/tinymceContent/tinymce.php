<?php
class add_st_content {

	var $pluginname = 'st_content';
	var $path = '';
	var $internalVersion = 100;

	function add_st_content()  {

		// Set path to editor_plugin.js
		$this->path = get_template_directory_uri() . '/lib/editor/tinymceContent/';
...
$tinymce_button = new add_st_content();
